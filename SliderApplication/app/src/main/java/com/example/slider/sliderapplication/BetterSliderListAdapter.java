...
/**
 * Created by niveditaupadhyay on 2/27/18.
 */

public class BetterSliderListAdapter extends ArrayAdapter {
    private Context context;
    public BetterSliderListAdapter(@NonNull Context context, @LayoutRes int resource) {
